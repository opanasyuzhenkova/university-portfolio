#Лабораторная работа 4 Панасюженкова О.Д. 2-ИВТ-1
...
lst = [1,2,2,3,4,5,6,6,7,7,8]
target = 8

def two_sum(lst, target):
  """
  _________
  Функция определяет пару индексов, сумма элементов по которым равна заданному числу target
  _________
  : 'lst' - массив значений
